...
<table width="100%" border="0" align="center">
  <tr>
    <td width="337" align="right"><img src="../img/logokecil.gif" width="52" height="52"><br></td>
    <td width="319" align="center"><strong>KARTU UJIAN TENGAH SEMESTER <?php echo"<br>$smm[ajaran] TAHUN 2016 <br>UNIVERISTAS WAHID HASYIM";//$thh[ajaran]?>
	</strong></td>
...
$krr = mysql_fetch_array($kr);
  ...
  <tr align="left" bgcolor="#FFFFFF">
    ...
    <td align="center"><?php echo"$kll[idkelas]"; ?></td>
...
<table width="100%" border="0" class="table table-bordered">
  <tr align="center">
    <td  align="left"><ul>Catatan :
        <li>Kartu ujian dianggap sah apabila ada stempel basah fakultas</li>
        <li>Harap mengupload foto resmi</li>
    </ul>
    <strong>    
   
    <td width="26%"><strong><?php echo"<br>
	DOSEN WALI<br><br><br><br><b>$dsnn2[nama]</b>"; ?></strong></td>
    <td width="14%"><?php  $ft = mysql_query("select * from foto_mhs where idmahasiswa='$mhss[idmahasiswa]' order by idfoto desc limit 1");
  $ftt  = mysql_fetch_array($ft); ?>
	...
	?>
	 ...
	 ?></td>
    <td width="26%"><strong><?php echo"<br>MAHASISWA<br><br><br><br>$mhss[nama]"; ?></strong></td>
  </tr>
</table>
<?php
}
