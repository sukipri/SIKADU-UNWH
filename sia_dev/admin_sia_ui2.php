...
<div class="list-group">
 ...
 <a href="<?php echo"ctk_tran_sks_try_urut.php?kdmhs=$mhss[idmahasiswa]"; ?>" target="_blank" class="list-group-item"><span>Print Trankrip </span></a>
 <?php

echo"<a href=# onClick=MM_openBrWindow('ctk_krs_mhs.php?kdmhs=$kdmhs','','scrollbars=yes,width=900,height=800') class=list-group-item><span>Print KRS</span></a>";
