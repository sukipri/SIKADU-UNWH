	...
	<form name="form1" method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
	  <table width="632" border="0" align="center" class="  rad">
		<tr>
		  <td width="72%" align="center"><img src="../img/logo-unwahas.png" width="385" height="91">        <table width="553" align="center" class="table">
			<tr>
			  <td width="545" class="bgk">
			  	<input name="nim" type="text" class="form-control form-control-sm" autocomplete="off"  style="max-width: 40rem;"  placeholder="NIM" required>
				  <br>
				 <input name="passuser" type="password" class="form-control form-control-sm" autocomplete="off" style="max-width: 40rem;"   placeholder="password" required>
				  <br>
    ...
    <div class="alert alert-dismissible alert-success">
        ...
        <ul>
          ...
          <li><b>Jika ada pertanyaan tentang SIKADU Kirim MyMail anda ke ID 80089 </b> </li>
          </ul>
	</div>
			  </td>
			</tr>
		  ...
		  if(isset($_POST["kirim"])){ 
			...
			if($bc > 1){
				...
				//header("location:index.php");
					echo"<font color=red><b>Password Dan NIM Salah</b></font>";
				}
			}else{
			echo"<font color=red><b>Password Dan NIM Salah</b></font>";
			} }
	...
	?>
		  ...
		  <br>
		  <span class="style12">&copy; sikadu.unwahas.ac.id dev bejotech-@mahasiswa</span> <span class="style2">
		  <?php
		  include"../sc/s_o.php";
