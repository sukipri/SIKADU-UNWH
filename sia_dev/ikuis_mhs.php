		...
		<button name="simpan" class="btn btn-success"><i class="fas fa-paper-plane"></i>&nbsp;Unggah</button>
        </center></div><br>
		...
		?>
		  ...
		  <table width="100%" border="0" align="center" bgcolor="#00F279" class="table table-bordered table-sm">
		...
		?>
		  ...
		  <tr>
			<td width="20" bgcolor="#FFFFFF">     <input type="radio" name="<?php echo"isi$i"; ?>" value="<?php echo"5"; ?>" required></td>
			<td width="20" bgcolor="#FFFFFF">    <input type="radio"name="<?php echo"isi$i"; ?>" value="<?php echo"4"; ?>" required></td>
			<td width="20" bgcolor="#FFFFFF">  <input type="radio" name="<?php echo"isi$i"; ?>" value="<?php echo"3"; ?>" required></td>
			<td width="20" bgcolor="#FFFFFF">  <input type="radio" name="<?php echo"isi$i"; ?>" value="<?php echo"2"; ?>" required></td>
			<td width="20" bgcolor="#FFFFFF">  <input type="radio" name="<?php echo"isi$i"; ?>" value="<?php echo"1"; ?>" required></td>
		  </tr>
		  <tr>
