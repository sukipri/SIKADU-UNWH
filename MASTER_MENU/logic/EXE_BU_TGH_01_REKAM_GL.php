<?php
    if(isset($_POST['tgh_simpan_rekam'])){
        ...
        while($no_mhs_tgh <= $jum_vmhs01_sw){
                ...
                $save_tgh_01_rekam_bri = $call_q("$in biaya_02_rekam_bri (id_biaya_rekam,idmahasiswa,nama,kode_bayar,kode,nominal,tgl,idsemester,app,device,THN,idmain_tagihan_01,idkejuruan)VALUES('','$nim','$nama','$kode_bayar','$kode_urut','$tgh_nom','$date_html5','$idsemester','1','TEST','$IDAJR01','$idmain_tagihan','$IDKEJ01')");
               /*
