<?php
			if(isset($_POST['simpan'])){
				...
				$masa_biaya = @$sql_escape($_POST['masa_biaya']);
					$up_tagihan_01 = $call_q("$up tb_tagihan_01 set idmain_jenis_tagihan='$jenis_tagihan',idgelombang='$gelombang',idtahun_ajaran='$tahun_ajaran',idkejuruan='$kej',kode_urut='$kode_urut',rule='$rule',rule_02='$rule02',masa_biaya='$masa_biaya',nominal='$nominal',kode_kelas='$kode_kelas' WHERE idmain_tagihan_01='$IDTG101'");
