<?php 
    ...
    <br />
        <a href="?HLM=BU_MST_M&SUB=BU_MST_M_UANG&SUB_CHILD=BU_MST_M_UANG_UP_UJIAN&SUB_CHILD_02=BU_MST_M_UANG_UP_UJIAN_UTS" class="btn btn-outline-info"><i class="fas fa-file-alt"></i>&nbsp;UTS</a>
         &nbsp;
