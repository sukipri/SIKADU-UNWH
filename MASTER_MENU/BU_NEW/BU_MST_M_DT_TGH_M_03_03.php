...
?>
    ...
    <br /><br />
    	<span class="badge badge-danger">#Entri baru</span>
    <br />
    <form method="post">
   ...
   <?php 
   	...
   	$no_mhs = 1;
  		$vmhs01_sw = $call_q("$sl idmahasiswa,idgelombang,idkejuruan,idtahun_ajaran,idsemester,nama,mhs,uts,uas,kode_kelas FROM mahasiswa WHERE idtahun_ajaran='$IDAJR01' AND idkejuruan='$IDKEJ01' and mhs='2'  AND krs='2'  order by idmahasiswa asc ");
...
<div style="overflow:auto;width:auto;height:40px;padding:10px;border:1px solid #eee">
   ...
   <?php 
   	$no_mhs02 = 1;
		$vrkm01_sw = $call_q("$call_sel biaya_02_rekam_bri WHERE idkejuruan='$IDKEJ01' AND kode_bayar='$vjtgh_sww02[nama]' AND THN='$IDAJR01' ORDER BY idsemester DESC");
