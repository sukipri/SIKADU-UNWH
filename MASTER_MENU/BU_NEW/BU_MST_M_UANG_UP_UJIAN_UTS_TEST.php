<?php 
	if(empty($_SESSION['namauser']) AND empty($_SESSION['passuser'])){
		...
		<span class="badge badge-success">#Update Global UTS Test</span>
       	 <hr> 
		<form method="post">
        ...
        <table width="100%" border="0" class="table table-bordered table-sm table-striped" style="max-width:60rem;">
              ...
              <?php 
			  	$unw_uts_no = 1;
				//MAHASISWA
					$unw_vmhs01_sw = $call_q("$sl idmahasiswa,idkejuruan,idsemester,nama,idtahun_ajaran,idsemester  FROM mahasiswa2 WHERE mhs='2' AND krs='2' AND idsemester='$vsmm_up[idsemester]' order by idmahasiswa asc limit 500");
    ...
    <br><br>
        <button name="unw_bu_uts_simpan_01" class="btn btn-success">UPDATE</button>
        </form>
      	<?php include"../logic/EXE_BU_UJIAN_UTS.php"; ?>
        <?php } ?>