<?php 
	...
	$gll = $call_fas($gl);
		...
		<tr>
		  ...
		  <td><a href="#biaya"  onClick="MM_openBrWindow('../../BU/add_biaya.php?<?php echo"kdmhs=$kmm[idmahasiswa]"; ?>','','scrollbars=yes,width=700,height=450')" class="btn btn-success"><i class="fas fa-money-check-alt"></i>&nbsp;INPUT BIAYA</a></td>
		</tr>
		<?php
		$no++;}}
		?>
		...
		<tr>
		 ...
		 ?> &nbsp; <a href="<?php echo"dtl_biaya_mhs.php?kdmhs=$kmm[idmahasiswa]"; ?>" target="_blank" class="btn btn-warning">Cetak Biaya</a></td>
		  <td height="36">&nbsp;</td>
		</tr>
