  ...
  <form method="post">
        ...
        <table width="100%" border="0" class="table table-bordered table-sm table-striped" style="max-width:60rem;">
              ...
              <?php 
				...
				//REKAM BRI
			  	$unw_vrbri01_sw = $call_q("$sl id_biaya_rekam,idmain_rekam,idmahasiswa,idsemester,app FROM biaya_02_rekam_bri WHERE idmahasiswa='$unw_vmhs01_sww[idmahasiswa]' AND ( app='2') AND  idsemester='$vsmm_up[idsemester]'");
