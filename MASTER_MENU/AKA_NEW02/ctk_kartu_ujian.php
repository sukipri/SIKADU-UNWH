...
<table width="100%" border="0" align="center">
  <tr>
    ...
    <td width="464" align="center"><strong>KARTU UJIAN AKHIR SEMESTER
          <?php 
...
<table width="100%" border="0" class="table table-bordered">
  <tr align="center">
    <td width="28%"  align="left"><ul>
        Catatan :
            <li>Kartu ujian dianggap sah apabila ada tanda tangan dosen wali &amp; stempel basah fakultas (stempel <strong>jangan</strong> mengenai barcode) </li>
...
$acak = rand(999,000);
$namafile= "uas.$kdmhs.$acak.$ack_time.png";
...
//QRCode::image($codeText,$quality,$ukuran,$padding);
   ...
   //QRcode::png('PHP QR Code :)');
	  ...
	  ?>
      <img src="<?php echo 'temp/' . $namafile; ?>" height="150" width="200"/><BR>
      </p></td>
