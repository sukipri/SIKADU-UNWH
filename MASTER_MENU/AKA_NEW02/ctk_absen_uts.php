...
<form name="form1" method="post" action="">
  <table width="100%" border="0" align="center" bgcolor="#000000">
    <tr align="center" bgcolor="#FFFFFF">
      ...
      <td height="40" colspan="5">NILAI</td>
    ...
    <tr align="center" bgcolor="#00E171">
      ...
      <td width="4%" bgcolor="#FFFFFF">NA</td>
      <td width="5%" bgcolor="#FFFFFF">NH</td>
    </tr>
    <?php
    $krs = mysql_query("select * from krs where idsks='$idsks' and app='2'");
	$i =1;
