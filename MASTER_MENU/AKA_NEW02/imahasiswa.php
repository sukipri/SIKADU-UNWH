...
echo "<script language='javascript'>alert('Maaf NIM $nim sudah ada')</script>";
	echo "<script language='javascript'>window.location = '?aka=imahasiswa'</script>";
	exit();
	}else{
mysql_query("insert into user_mhs(iduser_mhs,idmahasiswa,username,passuser,email,namaibu,app)values('','$nim','$un','$pu','$email','$namaibu','2')");
...
<form action="" method="post" name="form1" onSubmit="MM_validateForm('nim','','R','username','','R','email','','RisEmail','namaibu','','R','passuser','','R');return document.MM_returnValue">
  <table width="489" border="0" align="center" bgcolor="#FF8040" class="table table-bordered">
    <tr valign="top" bgcolor="#FFFFFF">
      <td colspan="2"><h3>Input User Mahasiswa &nbsp; &nbsp;<a href="#" onClick="MM_openBrWindow('vuser_mahasiswa.php','','scrollbars=yes,width=700,height=670')" class="btn btn-info">View user Mahasiswa</a> </h3></td>
    </tr>
    <tr valign="middle" bgcolor="#FFFFFF">
      <td width="117" height="49">NIM</td>
      <td width="362"><input name="nim" type="text" id="nim" size="40" class="form-control"></td>
    </tr>
    <tr valign="middle" bgcolor="#FFFFFF">
    ...
    <tr align="right" valign="middle" bgcolor="#FFFFFF">
      <td height="50" colspan="2"><input name="simpan" type="submit" id="simpan" value="simpan user mahasiswa" class="btn btn-success"></td>
    </tr>
  </table>
</form>
</body>
