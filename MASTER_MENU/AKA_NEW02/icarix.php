...
<table width="624" align="center">
  <tr>
    <td colspan="3" valign="top"><span class="style343"><img src="../img/search2.png" width="44" height="50">[<a href="?aka=icari_nim">Pencarian NIM</a>&nbsp; / &nbsp; <a href="?aka=icari">Mini Feed</a>] per Progdi
...
$dsnn = mysql_fetch_array($dsn);
  ...
  ?>
    <tr align="left" valign="top" bgcolor="#FFFFFF">
	 ...
	 if($ftht==1){
	 ?>
	 <a href="../file/<?php echo"$ftt[foto]"; ?>" class="btn btn-default" target="_blank">
	 <?php
	 echo"<center><img src=../file/dsncilik_$ftt[foto] width=150 height=150></center>"; 
	 }else{
	 ?>
	 </a>
