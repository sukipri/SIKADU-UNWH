...
$ack = rand("22","11");
$nim = "$kdmhs";
if($semester < $bii['semester']){
echo"Maaf Pembayaran Kurang";
}else{
mysql_query("insert into nota_mahasiswa(idnota_mahasiswa,idmahasiswa,idsemester,tgl,biaya,pembayaran,iduser)values('','$nim','$sme','$day','$bii[semester]','$semester','$uu[iduser]')");

//mysql_query("update mahasiswa set st='1' where idmahasiswa='$kdmhs'");
...
<table width="100%" border="0" align="center">
  <tr valign="top" bgcolor="#FFFFFF">
    ...
    PKM</h2></td>
    <td width="209"><img src="../img/20110301122202963.gif" width="190" height="75"></td>
  </tr>
</table>
...
<table width="100%" border="0" align="center" bgcolor="#00A854">
  ...
  <tr align="left" valign="middle" bgcolor="#FFFFFF">
    <td height="56">&nbsp;Uang Semester </td>
    <td><?php $k = number_format($bii['semester'],"0","","."); echo" &nbsp; Rp.$k"; ?></td>
  </tr>
  <tr align="left" valign="middle" bgcolor="#FFFFFF">
    <td height="34">Terbilang</td>
    <td>&nbsp;#<?php echo Terbilang($semester); ?>#</td>
  </tr>
  <tr align="left" valign="middle" bgcolor="#FFFFFF">
    <td height="34">&nbsp;Jumlah Uang </td>
    <td><?php 
	$jum = number_format($semester,"0","",".");
	echo"&nbsp;Rp.$jum"; ?></td>
  </tr>
  <tr align="left" valign="middle" bgcolor="#FFFFFF">
    <td height="34">kembali</td>
    <td><?php $kmbl = $semester - $bii['pkm']; 
	$kmbl_2 = number_format($kmbl,"0","",".");
	echo"&nbsp;Rp.$kmbl_2"; ?></td>
  </tr>
  <tr align="right" valign="middle" bgcolor="#FFFFFF">
    <td height="99" colspan="2"><?php $d = date("d F Y"); echo"<b>&nbsp; &nbsp;<i>$d</i></b>"; ?></td>
  </tr>
</table>
