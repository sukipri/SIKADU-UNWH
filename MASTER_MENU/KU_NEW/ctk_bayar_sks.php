...
mysql_query("insert into nota_sks(idnota_sks,idmahasiswa,idsemester,tgl,biaya,pembayaran,iduser)values('','$nim','$sme','$day','$tot_sks','$semester','$uu[iduser]')");
...
<table width="100%" border="0" align="center" bgcolor="#00A854">
  ...
  <tr align="center" valign="middle" bgcolor="#FFFFFF">
	...
	echo" Jumlah sks yang di ambil <b>$ju_krs</b> &nbsp; Pembayaran per SKS &nbsp; Rp.$k &nbsp; total Biaya seluruh SKS &nbsp; $k_sks"; ?></td>
  </tr>
