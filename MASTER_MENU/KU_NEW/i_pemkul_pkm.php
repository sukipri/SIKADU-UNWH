...
<body>
<form name="form1" method="post" action="<?php echo"ctk_bayar_pkm.php?kdmhs=$kdmhs"; ?>">
  <table width="678" border="0" align="center" bgcolor="#004080">
    <tr bgcolor="#FFFFFF">
      <td width="176" height="36">Biaya</td>
      <td width="326"><?php echo"<b>Rp.$k5</b>";
	 
	  ?></td>
      <td width="162" rowspan="3"><input name="simpan" class="sb" type="submit" id="simpan" value="simpan pembayaran"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="36">Pilih Pembayaran PKM</td>
