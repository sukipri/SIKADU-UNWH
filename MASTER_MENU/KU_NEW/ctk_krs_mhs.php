...
<table width="100%" border="0" align="center">
  <tr>
    ...
    <td width="319" align="center"><strong>KARTU RENCANA STUDI 
...
<br><table width="100%" border="0" align="center" bgcolor="#00B058">
  <tr align="center" bgcolor="#00E171">
    <td width="4%" height="31"><strong>NO</strong></td>
    <td width="10%"><strong>KODE MK </strong></td>
    <td width="16%"><strong>NAMA MAKUL </strong></td>
    <td width="7%"><strong>KELAS</strong></td>
    <td width="22%"><strong>DOSEN PENGAMPU </strong></td>
    <td width="11%"><strong>HARI</strong></td>
    <td width="15%"><strong>RUANG</strong></td>
    <td width="7%"><strong>Jam</strong></td>
    <td width="8%"><strong>SKS</strong></td>
  </tr>
  <?php
   $no=1;
  $krs1 = mysql_query("select * from krs where idmahasiswa='$kdmhs' and idsemester='$mhss[idsemester]' ");
...
$krr = mysql_fetch_array($kr);
  ...
  <tr align="center" bgcolor="#FFFFFF">
    ...
    <td><?php echo"$dsnn1[nama]"; ?></td>
    <td><?php echo"$skss1[hari]"; ?></td>
    <td><?php echo"$skss1[idruang]"; ?></td>
    <td><?php echo"$skss1[jam]"; ?></td>
...
$krr2 = mysql_fetch_array($kr2);
  ...
  <tr align="center" bgcolor="#FFFFFF">
    ...
    <td><?php echo"$kll[idkelas]"; ?></td>
    <td><?php echo"$dsnn12[nama]"; ?></td>
    <td><?php echo"$skss12[hari]"; ?></td>
    <td><?php echo"$skss12[idruang]"; ?></td>
    <td><?php echo"$skss12[jam]"; ?></td>
  ...
  ?>
  <tr bgcolor="#FFFFFF">
    <td height="31" colspan="8">Total Seluruh SKS </td>
    <td>
	<?php
