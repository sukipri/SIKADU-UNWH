...
$ack = rand("22","11");
$nim = "$kdmhs";
if($semester < $bii['registrasi']){
echo"Maaf Pembayaran Kurang";
}else{
mysql_query("insert into nota_reg(idnota_reg,idmahasiswa,idsemester,tgl,biaya,pembayaran,iduser)values('','$nim','$sme','$day','$bii[registrasi]','$semester','$uu[iduser]')");
...
<table width="100%" border="0" align="center" bgcolor="#00A854">
  ...
  <tr align="left" valign="middle" bgcolor="#FFFFFF">
    ...
    <td><?php $k = number_format($bii['registrasi'],"0","","."); echo" &nbsp; Rp.$k"; ?></td>
  </tr>
  <tr align="left" valign="middle" bgcolor="#FFFFFF">
  ...
  <tr align="left" valign="middle" bgcolor="#FFFFFF">
    ...
    <td><?php $kmbl = $semester - $bii['registrasi']; 
