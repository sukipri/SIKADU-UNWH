...
<table width="100%" border="0">
  ...
  <tr>
    <td align="center"><?php echo"<b>$kjj[kejuruan]&nbsp;$angg[ajaran]&nbsp; $mhss[idmahasiswa]&nbsp;&nbsp;<h3>LAP.PEM.PKM</h3></b>"; ?></td>
  </tr>
  <tr>
    <td><hr color="#000000"></td>
  </tr>
...
$by = mysql_query("select * from nota_pkm where idmahasiswa='$kdmhs' order by idpkm asc limit 2000");
...
$kby1 = number_format($bii['pkm'],"0","",".");
$kby2 = number_format($byy['jumlah'],"0","",".");
...
<table width="100%" border="0">
  ...
  <tr>
    <td><?php echo"Biaya PKM&nbsp;<b>Rp.$kby1</b>"; 
				echo"<br>Jumlah Pembayaran&nbsp;<b>Rp.$kby2</b>";
