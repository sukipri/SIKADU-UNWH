...
<body>
<form name="form1" method="post" action="<?php echo"ctk_bayar_regbea.php?kdmhs=$kdmhs"; ?>">
  <table width="569" border="0" align="center" bgcolor="#004080">
    <tr bgcolor="#FFFFFF">
      <td width="191" height="36">Biaya</td>
      <td width="368"><?php echo"<b>Rp.$k4</b>";?></td>
      <td width="368" rowspan="4"><input name="simpan" type="submit" id="simpan" value="simpan pembayaran" class="sb"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
