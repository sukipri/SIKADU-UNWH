...
<table width="100%" border="0">
  ...
  <tr>
    <td align="center"><?php echo"<b>$kjj[kejuruan]&nbsp;$angg[ajaran]&nbsp; $mhss[idmahasiswa]&nbsp;&nbsp;<h3>LAP.PEM.SEMESTER</h3></b>"; ?></td>
  </tr>
  <tr>
    <td><hr color="#000000"></td>
  </tr>
...
$by = mysql_query("select * from nota_mahasiswa where idmahasiswa='$kdmhs' order by idnota_mahasiswa asc limit 2000");
...
$kby1 = number_format($byy['biaya'],"0","",".");
...
<table width="100%" border="0">
  ...
  <tr>
    <td><?php echo"Biaya Per Semester&nbsp;<b>Rp.$kby1</b>"; 
