...
<table width="100%" border="0">
  ...
  <tr>
    <td align="center"><?php echo"<b>$kjj[kejuruan]&nbsp;$angg[ajaran]&nbsp; $mhss[idmahasiswa]&nbsp;&nbsp;<h3>LAP.PEM.SPI</h3></b>"; ?></td>
  </tr>
  <tr>
    <td><hr color="#000000"></td>
  </tr>
...
$by = mysql_query("select * from spi where idmahasiswa='$kdmhs' order by idspi asc limit 2000");
...
$kby1 = number_format($byy['pembayaran'],"0","",".");
$kby2 = number_format($bii['spi'],"0","",".");
...
<table width="100%" border="0">
  ...
  <tr>
    <td><?php echo"Biaya SPI&nbsp;<b>Rp.$kby2</b>"; 
				echo"<br>Pembayaran&nbsp;<b>Rp.$kby1</b>";
