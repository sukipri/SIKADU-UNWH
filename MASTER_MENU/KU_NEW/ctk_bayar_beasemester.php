...
$nim = "$kdmhs";
 $o = $beaa1['potongan'];
	  ...
	  $totdis = $bii['semester'] - $dis;
if($semester < $totdis){
echo"Maaf Pembayaran Kurang";
}else{
mysql_query("insert into nota_mahasiswa(idnota_mahasiswa,idmahasiswa,idsemester,tgl,biaya,pembayaran,iduser,bea)values('','$nim','$sme','$day','$bii[semester]','$semester','$uu[iduser]','Y')");
...
<table width="100%" border="0" align="center">
  <tr valign="top" bgcolor="#FFFFFF">
    ...
    <td width="291" align="center" valign="middle"><h2>Tanda Setoran <br>SPP</h2></td>
...
<table width="100%" border="0" align="center" bgcolor="#00A854">
  ...
  <tr align="left" valign="middle" bgcolor="#FFFFFF">
    ...
    <td><?php $k = number_format($bii['semester'],"0","","."); 
	$kdis = number_format($totdis,"0","",".");
	echo" &nbsp; Rp.$k&nbsp; (Rp.$kdis)"; ?></td>
  </tr>
  <tr align="left" valign="middle" bgcolor="#FFFFFF">
    <td height="60">Terbilang</td>
    <td>&nbsp;#<?php echo Terbilang($semester); ?>#</td>
  </tr>
  <tr align="left" valign="middle" bgcolor="#FFFFFF">
    <td height="57">&nbsp;Jumlah Uang </td>
    <td><?php 
	$jum = number_format($semester,"0","",".");
	echo"&nbsp;Rp.$jum"; ?></td>
  </tr>
  <tr align="left" valign="middle" bgcolor="#FFFFFF">
    <td height="47">kembali</td>
