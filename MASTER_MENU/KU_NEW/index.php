		  ...
		  <td width="72%" align="center"><img src="../../img/logo-unwahas.png" width="385" height="91">        <table width="553" align="center" class="table">
			<tr>
			  <td width="545" class="bgk">
				  ...
				  <br>
				 <input name="passuser" type="password" autocomplete="off" class="form-control" style="max-width: 40rem;"   placeholder="password" required>
				  <br>
				   
					<?php echo"<span class=style1>Kode <b>$hasil_01</b></span>"; ?>
					 <input name="an_sec" autocomplete="off" type="hidden"  class="form-control" style="max-width: 15rem;" placeholder="Masukan Kode " value="<?php echo"$hasil_01"; ?>"   required>
				    <input name="angka1" type="number" autocomplete="off"  class="form-control" style="max-width: 15rem;" placeholder="Masukan Kode "   required>
				  <br>
	...
	?>
		  ...
		  <br>
		  <span class="style12">&copy; sikadu.unwahas.ac.id dev bejotech-@BU</span> <span class="style2">
		  <?php
		  include"../../sc/s_o.php";
